...
public class CalculatorPage {
	...
	public void gotoCalculatorSection() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(calculatorSection));
		WebElement calculatorElement = driver.findElement(calculatorSection);
		Actions actions = new Actions(driver);
		actions.moveToElement(calculatorElement).perform();
	}
	...
	public void enterIndiaInToCountry() {
		...
		WebElement toCountryElement = wait.until(ExpectedConditions.visibilityOfElementLocated(toCountry));
		toCountryElement.clear();
		
		
		toCountryElement.sendKeys("India");
	...
	public void enterFromPostCode() {
	    ...
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
	    WebElement postCodeElement = wait.until(ExpectedConditions.visibilityOfElementLocated(fromPostCode));
	    
	    // Move to the element and perform the action
	    Actions actions = new Actions(driver);
	    actions.moveToElement(postCodeElement).perform();
	    postCodeElement.sendKeys("35600");
	}
	...
	public void enterWeight() {
	    ...
	    // Move to the element and perform the action
	    Actions actions = new Actions(driver);
	    actions.moveToElement(weightElement).perform();
	    weightElement.sendKeys("1");
	}
